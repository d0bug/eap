...
class Common_util_pub
{
	...
	public $JS_API_CALL_URL = 'http://vip.gaosiedu.com/Vip/GsWeixin/pay';
	
	//=======【异步通知url设置】===================================
	//异步通知url，商户根据实际开发过程设定
	public $NOTIFY_URL = 'http://vip.gaosiedu.com/wxpay/notify.php';
	...
	function __construct($config) {
		...
		if(isset($config['appid'])){
			...
			//受理商ID，身份标识
			$this->MCHID = '1375789102';
			//商户支付密钥Key。审核通过后，在微信发送的邮件中查看
			$this->KEY = '16498a1e4250ed3d3d870930787bfc62';
			//JSAPI接口中获取openid，审核后在公众平台开启开发模式后可查看
			$this->APPSECRET = 'd8a3f2d5f19ee73592b991c0b400be2d';		
			//=======【证书路径设置】=====================================
			//证书路径,注意应该填写绝对路径
			$this->SSLCERT_PATH = '/data/wwwroot/eap/Library/COM/WxPayPubHelper/cacert/apiclient_cert.pem';
			$this->SSLKEY_PATH = '/data/wwwroot/eap/Library/COM/WxPayPubHelper/cacert/apiclient_key.pem';
			//商户名称
			$this->COMPANY = '北京爱提分博乐教育科技有限公司';
