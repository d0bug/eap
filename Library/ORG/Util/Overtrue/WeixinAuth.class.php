...
//import('ORG.Util.Overtrue.Wechat.Utils.Bag');
//import('ORG.Util.Overtrue.Wechat.Input');
//import('ORG.Util.Overtrue.Wechat.Http');

require_once(dirname(__FILE__) . '/Wechat/Http.php');
require_once(dirname(__FILE__) . '/Wechat/Input.php');
require_once(dirname(__FILE__) . '/Wechat/Url.php');
