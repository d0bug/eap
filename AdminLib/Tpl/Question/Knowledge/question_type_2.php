...
<script type="text/javascript">
	...
	function appendTR(id, euid, content, is_answer) {
		...
		var checkboxId = 'options_answer_flag_' + len + '_{$suffix}';
		...
		var html = '<tr class="options">' +
						'<td style="width: 50px; text-align: center; border: 0px">' +
							...
							'<label><input type="checkbox" id="' + checkboxId + '" name="options_answer_flag[]" class="isanswer" value="' + val + '" ' + checked + ' /> <span class="ft_16 options_answer_flag">' + get_option_flag_name( len ) + '</span></label>' +
