...
<else />
	...
	<div class="qt_box mr_b_5">
		...
		<div class="info" style="padding: 5px 0 0 10px;">
			...
			<span style="float:left; margin-left: 25px;" class="blod">修改时间：{$question['content_last_updated_time']}</span>
			<span style="float:right; margin-right: 10px;" class="blod">{$question['content_error_types'] | get_content_error_names}</span>
		</div>
