...
<div class="easyui-layout" fit="true">
	...
	<div region="center">
		...
		<dl>
			<dt>试听组标题</dt>
			<dd><input type="text" id="group_title" name="group_title" class="easyui-validatebox" required="true" /></dd>
			<dt>课节范围：</dt>
			<dd><input type="text" id="min_lesson" name="min_lesson" class="easyui-validatebox easyui-numberspinner" size="9" min="1" maxlength="20" required="true" /> — 
				<input type="text" id="max_lesson" name="max_lesson" class="easyui-validatebox easyui-numberspinner" size="9" min="1" maxlength="20" required="true" /></dd>
		</dl>
		</form>
	</div>
</div>
