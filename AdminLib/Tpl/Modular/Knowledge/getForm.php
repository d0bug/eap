...
<div id="main">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableInfo">
		...
		<tr>
			<td class="alt"><font color="red">*</font>题模数量： </td>
			<td>

				<input type="text" name="mod_max" id="mod_max" value="<?php echo $mod_max;?>">
			</td>

		<tr>
			<td class="alt"><font color="red">*</font>flash地址： </td>
			<td>

				<input type="text" name="flash_url" id="flash_url" value="<?php echo $flash_url;?>">
			</td>
		</tr>
		<tr>
			<td class="alt">排序： </td>
