...
<?php if($is_exists == 0):?><br><br>&nbsp;&nbsp;&nbsp;&nbsp;
	<font size="3">抱歉，没有找到预览版讲义！</font><?php if($handoutsInfo['is_teaching_and_research']==1):?><a href="<?php echo U('Vip/VipHandouts/download',array('hid'=>$handoutsInfo['hid'],'type'=>$handoutsInfo['type']));?>" ><?php if($handoutsInfo['type']==1):?>下载试题<?php else:?>下载学生版<?php endif;?></a><?php endif;?>&nbsp;&nbsp;
<?php else:?><br>&nbsp;
	<font size="3">讲义标题：<?php echo $handoutsInfo['title'];?></font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php if($handoutsInfo['is_teaching_and_research']==1):?><a href="<?php echo U('Vip/VipHandouts/download',array('hid'=>$handoutsInfo['hid'],'type'=>$handoutsInfo['type']));?>" ><?php if($handoutsInfo['type']==1):?>下载试题<?php else:?>下载学生版<?php endif;?></a><?php endif;?>&nbsp;&nbsp;
