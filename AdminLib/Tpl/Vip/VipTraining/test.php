...
<body style="padding: 5px;">
	<div id="basic-dict-layout" class="easyui-layout" data-options="border: false, fit: true">
		<div region="west" style="width: 300px;" data-options="title:'测试管理', iconCls:'icon-table', split: true, minWidth: 800">
			<table id="easyui-datagrid" class="easyui-datagrid" data-options="url: '/Vip/VipTraining/testInfo',
																	  iconCls: 'icon-table',
																	  striped: true,
				...
				<thead>
					<tr>
						...
						<th field="ts_name" width="50px">测试名称</th>
                        ...
                        <th field="wei" width="50px">未完成人数</th>
...
<!--End 基础属性添加/编辑对话框-->
	...
	<script language='javascript' type='text/javascript'>
       ...
       function edit_dict() {        
		...
		params.href = '/Vip/VipTraining/addTest?id=' + row.id;
		$('#basic-index-knowledge-add-dlg').dialog(params).dialog('open');
      ...
      function easyui_delete() {
			...
			if (row) {
				$.messager.confirm('操作提示', '您确实要删除吗？', function (r) {
					if (r) {
						$.post('/Vip/VipTraining/delTest', { id: row.id }, function (result) {
							if (result.status) {
