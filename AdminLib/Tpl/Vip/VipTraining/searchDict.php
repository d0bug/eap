...
<div class="easyui-layout" data-options="fit: true">
	<div region="north" data-options="fit: true, collapsible: false, border: false">
		<form id="dict-add-form" method="post" novalidate action="/Vip/VipTraining/treated_search_dict" onSubmit="return myCheck()">
            			...
            			if(!empty($dictInfo)){
            					foreach ($dictInfo as $k=>$module){
            						...
            						if(in_array($id,$contain_module))
            							...
            							$chk = '';
            						?>
            						<li><span id="span_module_<?php echo $k+1;?>"><input type="checkbox" id="module_<?php echo $k+1;?>" name="contain_module[]" value="<?php echo $id?>" size="10" <?php echo $chk?>>&nbsp;&nbsp;<?php echo $name;?></span>&nbsp;&nbsp;</li>
            					<?php
            					}
            				}
            			?>
