...
<div region="center">
<div id="main">
	<h1><?php echo $one_Circleinfo;?>  &nbsp;&nbsp;<a href="/vip/vip_circle/VipcircleList">返回列表</a></h1>
		<form id="form1" name="form1">
	    <input type="hidden" name="cid" id="cid" value="<?php echo $cid;?>" />
		<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableInfo">
			<tr><td class="alt" style="width:50px"><font color=red>*</font>评论：</td>
	...
	<div id="list" class="clearfix">
		...
		<table width="100%">
			...
			<tr height=30>
				...
				<td><?php echo $CirRep['content'];?></td>
				<td><?php echo $CirRep['uid'];?></td>
				<td><?php echo $CirRep['uname'];?></td>
				<td><?php echo date('Y-m-d H:i:s',$CirRep['instime']);?></td>
				<td><?php echo $CirRep['ip'];?></td>
				<td><?php if($CirRep['status'] == 1) echo '是'; else echo '否';?></td>
...
<script type="text/javascript">
	function check(){	
		...
		var cid = $("#cid").val();
		var url = '/vip/vipCircle/Comment_content';
		$.ajax({
		    type:'POST',
		    url:url,
...
function Del_CircleReplyInfo(rid){
		...
		var rid = rid;
		var url = '/vip/vip_circle/DelCiRply'
		$.ajax({
		    type:'POST',
		    url:url,
		    data:{rid:rid},
