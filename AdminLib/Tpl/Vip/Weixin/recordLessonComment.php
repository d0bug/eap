...
<article class="wrap">
	<div class="heluInfo">
			...
			<?php if(empty($heluInfo['comment'])):?>
				<textarea id="comment" name="comment" style="height: 400px; font-size: 14px;" cols="10" rows="5" placeholder="请输入课堂评价"><?php echo date('Y/m/d',strtotime($heluInfo['lesson_date'])) ?> <?php echo preg_replace('/[0-9]/','',$userInfo['real_name'])?>老师课堂评价:</textarea>
				<?php else:?>
					<textarea id="comment" name="comment" style="height: 400px; font-size: 14px;" cols="10" rows="5" placeholder="请输入课堂评价"><?php echo $heluInfo['comment']?></textarea>
				<?php endif;?>
			</div>
