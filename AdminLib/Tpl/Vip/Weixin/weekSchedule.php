...
<article class="wrap">
	<ul class="modTab">
		<li class="current"><a href="<?php echo U('Vip/Weixin/weekSchedule',array('openid'=>$userInfo['openId']))?>">周课表</a><i></i></li>
		<li><a href="<?php echo U('Vip/Weixin/monthSchedule',array('openid'=>$userInfo['openId']))?>">月课表</a><i></i></li>
	</ul>
	<div class="courseHd">
		<label class="selbar">
...
function changeWeek(key){
	window.location.href="<?php echo U('Vip/Weixin/weekSchedule')?>/key/"+key;
}
</script>
</body>
</html>
