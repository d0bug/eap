...
<article class="wrap">
	<ul class="modTab">
		<li ><a href="<?php echo U('Vip/Weixin/newWeekSchedule',array('openid'=>$userInfo['openId']))?>">周课表</a><i></i></li>
		<li class="current"><a href="<?php echo U('Vip/Weixin/newMonthSchedule',array('openid'=>$userInfo['openId']))?>">月课表</a><i></i></li>
	</ul>
	<div class="courseHd">
		<label class="selbar">
...
function changeMonth(key){
	window.location.href="<?php echo U('Vip/Weixin/newMonthSchedule')?>/key/"+key;
}
</script>
</body>
</html>
