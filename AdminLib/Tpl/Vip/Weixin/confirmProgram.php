	...
	<form id="confirm" name="confirm" method="POST">
		<div class="upPhoto">
			...
			<div class="modCon">
					...
					<input type="hidden" id="from_type" name="from_type" value="1">
					<dl>
						<dt>请选择学员姓名：</dt>
						<dd>
							<span class="selbar">
			...
			<div class="modCon">
				<div class="button">
					<input type="button" class="btn" value="确认上传" onclick="return checkProgramForm('confirm','<?php echo U('Vip/Weixin/doConfirmProgram')?>')">
...
$(function () {
	$.get('<?php echo U('Vip/Weixin/getAllStudents',array('jieke'=>0))?>',
	function(data){
