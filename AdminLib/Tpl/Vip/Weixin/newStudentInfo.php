...
<article class="wrap">
	<ul class="modTab">
		...
		<li><a href="<?php echo U('Vip/Weixin/newKechengList',array('student_code'=>$student_code,'kecheng_code'=>$kecheng_code,'student_name'=>$studentInfo['sstudentname'],'grade'=>$studentInfo['gradename'],'lesson'=>$lesson))?>">学员课程</a><i></i></li>
	</ul>
	<div class="stuInfo">
