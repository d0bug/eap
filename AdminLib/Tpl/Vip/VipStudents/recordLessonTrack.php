	...
	<div class="panel-right">
		...
		<form id="form2" name="form2" method="POST" >
			<div class="panel-right-con2">
				...
				<textarea id="comment" name="comment" ><?php if(empty($heluInfo['comment'])):?><?php echo date('Y/m/d',strtotime($heluInfo['lesson_date'])) ?> <?php echo preg_replace('/[0-9]/','',$userInfo['real_name'])?>老师课堂评价:
				<?php else:?><?php echo $heluInfo['comment']?>
				<?php endif;?></textarea>
			...
			<div class="panel-right-bluebtn" id="save_form2" onclick="return save_form2('<?php echo U('Vip/VipStudents/savePartTwo')?>')" >保存并复制</div>
		</form>
		<br>
		<br>
