...
<body>
<form id="add_video" name="add_video" method="POST" enctype="multipart/form-data"  action="<?php echo U('Vip/VipOperation/updateVideo',array('auto_close'=>$auto_close));?>">
<div id="main">
		<h2>视频上传</h2>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableInfo">
            ...
            <tr>
                ...
                <td>                    
                    <select id="video_type" name="video_type">
                        <option value="<?php echo $videoInfo['video_type'];?>" ><?php echo $videoInfo['video_type_name'];?></option>
			...
			<tr>
				...
				<td>
					<input type="text" id="title" name="title" placeholder="请输入视频名称..." value="<?php echo $videoInfo['title']?>" size="100"  onkeydown="return check_length('title','titleMsg',100)" onkeyup="return check_length('title','titleMsg',100)"><span id="titleMsg">还可输入100个字</span>
				</td>
			</tr>
