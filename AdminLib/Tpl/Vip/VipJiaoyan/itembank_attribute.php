...
<?php if($is_jiaoyan == 1):?>
	<div id="setAttribute" style="display:<?php if($permissionList == 1):?>none<?php else:?>block;<?php endif;?>">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableInfo">
			<tr valign="top">
				...
				<td>
					...
					<?php if($permInfo['permValue']==3):?>
						<a href="#" onclick="add_item('subject',1,'<?php echo U('Vip/VipJiaoyan/get_form')?>')"><img src="/static/images/add.png"></a>&nbsp;&nbsp;&nbsp;
						<a href="#" onclick="return deleteAttribute('subject',1,'<?php echo U('Vip/VipJiaoyan/delete_attribute')?>')"><img src="/static/images/delete.png"></a>&nbsp;&nbsp;&nbsp;
						<a href="#" onclick="return testMessageBox_editAttribute(event,'subject','<?php echo U('Vip/VipJiaoyan/edit_attribute',array('ntype'=>1))?>')"><img src="/static/images/edit.png"></a>
					<?php endif;?>
					</div>
				</td>
			</tr>
			...
			<tr valign="top">
				<td class="alt" style="width:80px"><font color=red>*</font>题库属性：</td>
				<td>
					...
					<div class="btnBar">
					<?php if($permInfo['permValue']==3):?>
						<a href="#" onclick="add_item('grade',1,'<?php echo U('Vip/VipJiaoyan/get_form')?>')"><img src="/static/images/add.png"></a>&nbsp;&nbsp;&nbsp;
						<a href="#" onclick="return deleteAttribute('grade',1,'<?php echo U('Vip/VipJiaoyan/delete_attribute')?>')"><img src="/static/images/delete.png"></a>&nbsp;&nbsp;&nbsp;
						<a href="#" onclick="return testMessageBox_editAttribute(event,'grade','<?php echo U('Vip/VipJiaoyan/edit_attribute',array('ntype'=>1))?>')"><img src="/static/images/edit.png"></a>
					<?php endif;?>
					</div>
				</td>
			</tr>
			...
			<tr valign="top">
				<td class="alt" style="width:80px"><font color=red>*</font>试题属性：</td>
				<td>
					...
					<div class="btnBar">
					<?php if($permInfo['permValue']==3):?>
						<a href="#" onclick="add_item('knowledge',1,'<?php echo U('Vip/VipJiaoyan/get_form')?>')"><img src="/static/images/add.png"></a>&nbsp;&nbsp;&nbsp;
						<a href="#" onclick="return deleteAttribute('knowledge',1,'<?php echo U('Vip/VipJiaoyan/delete_attribute')?>')"><img src="/static/images/delete.png"></a>&nbsp;&nbsp;&nbsp;
						<a href="#" onclick="return testMessageBox_editAttribute(event,'knowledge','<?php echo U('Vip/VipJiaoyan/edit_attribute',array('ntype'=>1))?>')"><img src="/static/images/edit.png"></a>
					<?php endif;?>
					</div>
				</td>
			</tr>
			...
			<tr valign="top">
				<td class="alt" style="width:80px"><font color=red>*</font>权限：</td>
				<td>
		...
		<br />
		<input type="button" class="btn" value=" 知识点权限信息一览表 " onclick="javascript:window.location.href='<?php echo U('Vip/VipJiaoyan/itembank_attribute',array('is_permissionList'=>1))?>';">
		<br />
		</div>
		<div id="attributeList" style="display:<?php if($permissionList == 1):?>block<?php else:?>none;<?php endif;?>">
			<h2>知识点权限信息一览表：</h2>
			<div id="search">
			<form id="permission_form" name="permission_form" action="<?php echo U('Vip/VipJiaoyan/itembank_attribute',array('is_permissionList'=>1))?>" method="GET">
				...
				题库属性：<select id="gid" name="gid"  onchange="get_option(this.value,'kid','<?php echo U('Vip/VipHandouts/get_knowledge_option')?>','attr')">
							<option value="">请选择题库属性</option>
							<?php foreach($gradeArr as $key=>$grade):?>
								<option value="<?php echo $grade['gid']?>"><?php echo $grade['name']?></option>
							<?php endforeach?>
						 </select>
				试题属性：<select id="kid" name="kid">
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableList">
				...
				<tr>
					<td><?php echo $permission['sname'];?></td>
					<td><?php echo $permission['gname'];?></td>
					<td><?php echo $permission['kname'];?></td>
					<td><?php if($permission['permission']==1):?><font color=red>仅教研人员可见</font><?php else:?><font color=green>所有人可见</font><?php endif;?></td>
					<td><?php echo $permission['nnames'];?></td>
				</tr>
				<?php endforeach?>
			</table><br>
			<input type="button" class="btn" value=" 关闭 " onclick="javascript:window.location.href='<?php echo U('Vip/VipJiaoyan/itembank_attribute')?>'"><br>
		</div>
<?php else:?>
	抱歉，您无权操作此功能！
<?php endif;?>
