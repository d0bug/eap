...
<h2>添加公告</h2>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableInfo">
		<tr><td class="alt" style="width:80px"><font color=red>*</font>活动标题：</td>
			<td><input type="text" id="title" name="title" value="" placeholder="输入活动标题..." size="100" onkeydown="return check_length('title','titleMsg',100)" onkeyup="return check_length('title','titleMsg',100)"> <span id="titleMsg">还可输入100个字</span></td>
		</tr>
		<tr><td class="alt" style="width:80px"><font color=red>*</font>关键词：</td>
			<td><input type="text" id="keywords" name="keywords" value="" placeholder="输入关键词..." size="100" "> 
				<span>多个关键词之间用英文的逗号（,）分隔，建议80字以内。</span>
			</td>
		</tr>
		<tr><td class="alt" style="width:80px"><font color=red>*</font>活动描述：</td>
			<td><textarea id="description" name="description" cols="100" rows="2" placeholder="输入活动描述..."></textarea> <span>描述建议160字以内。</span></td>
		</tr>
		...
		<tr><td class="alt" style="width:80px"><font color=red>*</font>活动内容：</td>
			<td><textarea name="ncontent" id="ncontent" style="width:60%;height:500px" placeholder="输入活动内容..."></textarea><span id="ncontent_msg" class="error"></span>
	            <?php echo W('EditorOss', array('id'=>'ncontent','layout'=>'simple'))?>
	        </td>
	    </tr>
		<tr><td>&nbsp;</td>
			<td>
			<input type="submit" name="save_close" class="btn" value="添加活动">
			</td></tr>
	</table>
	</form>
</div>
