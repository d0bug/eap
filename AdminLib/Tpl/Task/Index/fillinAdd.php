    ...
    <div class="container">
      <h2><?php echo $aQustionInfo['sname'];?><small><?php echo $aQustionInfo['sclasstypecode'];?></small><?php echo $aQustionInfo['stopic'];?><?php echo $aQustionInfo['nyear'],'-',$aQustionInfo['nseason'];?>学期</h2>
        ...
        <form class="form-horizontal" role="form" id="formq" method="post" action="/Task/Index/multyUpdate">
              ...
              <div class="form-group">
                <label for="nValue" class="col-sm-2 control-label">选项</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="options" name="options[<?php echo $value['sort'];?>][options]" value="<?php echo $value['options'];?>" placeholder="选项">
                </div>
              </div>
              <div class="form-group">
                <label for="nValue" class="col-sm-2 control-label">答案</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="answer" name="options[<?php echo $value['sort'];?>][answer]" value="<?php echo $value['answer'];?>" placeholder="答案">
                </div>
              </div>
              <div class="form-group">
