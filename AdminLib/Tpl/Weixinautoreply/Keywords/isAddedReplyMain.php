...
$(function(){
  ...
  $(".sub-addIsAddedReply").click(function(){
	  $("#addIsAddedReply").submit();
  })
  $("#addIsAddedReply").validate({
    rules: {
      reply_content: {
        required: true,
        minlength: 1
  ...
  $(".sub-del").bind('click', function(event){
    ...
    $.post('/weixinautoreply/Keywords/ajax_delIsAddedReply', {account_id: account_id}, function(responseData) {
      if(responseData.status==1){
  ...
  $(".sub-update").bind('click', function(event){
    event.preventDefault();
    var editForm = $(this).parents(".cls-editIsAddedReply");
    editForm.validate({
      rules: {
        reply_content: {
          required: true,
...
<div class="container">
  <div class="row">
    <div class="col-md-10">
      <h2>关键词自动回复规则</h2>
      <button class="btn btn-default" data-toggle="modal" data-backdrop="false" data-keyboard="false" data-target="#editIsAddedReplyModal">新增被添加自动回复</button>
      <?php if($arrIsAddedReply): ?>
      <div class="panel-group" id="accordion">
        <?php foreach ($arrIsAddedReply as $i => $item): ?>
        <div class="panel panel-default node-item">
          ...
          <div id="collapse<?php echo $i; ?>" class="panel-collapse collapse">
            <div class="panel-body">
              <form class="form-horizontal cls-editIsAddedReply" role="form" action="/weixinautoreply/Keywords/ajax_editIsAddedReply" method="post">
...
<div class="modal fade" id="editIsAddedReplyModal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" role="form" id="addIsAddedReply" action="/weixinautoreply/Keywords/ajax_addIsAddedReply" method="post">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary sub-addIsAddedReply">保存</button>
      </div>
    </div>
    <!-- /.modal-content --> 
  </div>
