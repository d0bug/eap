...
<div><label><span>所属应用：</span>所属应用标识<br />
            <input type="text" disabled="true" value="<?php echo $groupName?>" />
        </label></div>
<div><label><span>角色名称：</span>角色的中文名称<br />
            <input type="text" class="easyui-validatebox" required="true" name="role_caption" />
        </label></div>
<div><label><span>角色介绍：</span>角色介绍，可为空<br />
