...
jQuery(function($) {
	$(".submitQuestion").click(function(){
		...
		if(_type != 3){
			var _answer = $(form).find("input[name='answer']").val().replace(/^(\s|\u00A0)+/,'').replace(/(\s|\u00A0)+$/,'');
...
<?php if ($one['qtype'] == 3){?>
		<div class="form-group">
			...
			<div class="col-md-1">
			<input type="text" class="form-control" name="qindex" id="qindex" value="<?php echo $one['qindex'];?>">
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-md-2">
			<input type="text" name="score" value="<?php echo $one['score']; ?>" class="form-control" placeholder="请输入分数">
			</div>
		</div>
		<div class="form-group">
			<div class="col-md-offset-2 col-md-2">
