...
<script type="text/javascript">
  ...
  function checkUploadPics(){
    if($.trim($(".uploads-container").html()) == ''){
      failedTip('作业解答不能为空。');
      return false;
    }
    return true;
  ...
  function checkSubjects(){
    ...
    $(".subject-row").each(function(){
      ...
      if(subject_no.length == 0 || subject_no <= 0 || subject_score.length == 0 || subject_score <= 0){
        status = 0;
      }
    })
    if(status == 0){
  ...
  function getSubjects(){
    ...
    $(".subject-row").each(function(){
      ...
      onesubject.push(subject_no, subject_score);
...
<div class="container">
  <div class="row">
    <div class="col-md-10">
      ...
      <form class="form-horizontal" role="form" id="addHomework" action="/homework/mid_science/edit" method="post">
        <div class="form-group">
          ...
          <div class="col-md-10">
            ...
            <div class="uploads-container">
              <?php foreach($hwPicArr as $hwPic): ?>
                <div><button type="button" class="close" onclick="delOnePic(this)">X</button><img src="/upload/wx_hw{$hwPic}" /></div>
              <?php endforeach; ?>
            </div>
          </div>
        </div>
        <div class="form-group subject-container">
          ...
          <?php foreach($hwSmallSubjectArr as $k => $item): ?>
          <div style="margin: 0 0 20px 110px; display: table;" class="subject-row">
            ...
            <div class="col-md-1" style="width:100px;">
              <input type="number" class="form-control subject-no" placeholder="题号" value="{$item.subject_no}" />
            </div>
            <div class="col-md-1" style="width: 60px;">
              <p class="form-control-static">满分</p>
            </div>
            <div class="col-md-1" style="width:100px;">
              <input type="number" class="form-control subject-score" placeholder="满分" value="{$item.fullscore}" />
            </div>
            <?php if($k == 0): ?>
            <div class="col-md-1" style="width:100px;">
            ...
            <?php else: ?>
            <div class="col-md-1" style="width:100px;">
              <button type="button" class="btn btn-danger del-subject">删除此题</button>
            </div>
            <?php endif; ?>
          </div>
          <?php endforeach; ?>
