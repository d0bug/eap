      ...
      <div class="modal-body">
              ...
              <?php if(isset($aQuestionInfo['sQuestion']['options'])):?>
               <div class="form-group">
                <label for="inputPassword" class="col-sm-2 control-label">选项[<a href="javascript:void(0)" onclick="addOpions(2)">+</a>]</label>
                <div class="col-sm-10">
                <div id="option0" style="display:none;"></div>
						   ...
						   <div class="form-group" id="<?php echo chr(65+$chr);?>">
			                ...
			                <input name="corrent_answer[]" value="<?php echo $chr;?>" <?php  if(in_array($chr, explode('|', $aQuestionInfo['corrent_answer'])) ) echo 'checked';?> type="checkbox">
