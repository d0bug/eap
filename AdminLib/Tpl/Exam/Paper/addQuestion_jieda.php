    ...
    <body class="easyui-layout" fit="true" border="false">
        ...
        <div region="center">
            <div class="easyui-tabs" fit="true" border="false">
                <div title="小题题干">
                <textarea id="ques_content" name="ques_content" style="width:99%;height:245px"></textarea>
        <?php echo W('Editor', array('id'=>'ques_content'));?>
                ...
                <div title="试题答案&错题分析">
                    <table class="quesInfo" width="100%" cellpadding="4" cellspacing="0">
                        ...
                        <tr><td><textarea id="ques_answer" name="ques_answer" style="width:99%;height:230px"></textarea></td>
                        <td><textarea id="ques_analy" name="ques_analy" style="width:99%;height:230px"></textarea></td></tr>
                    </table>
                    <?php echo W('Editor', array('id'=>'ques_answer','layout'=>'simple'))?>
                    <?php echo W('Editor', array('id'=>'ques_analy','layout'=>'simple'))?>
                </div>
                <div title="考查内容">
