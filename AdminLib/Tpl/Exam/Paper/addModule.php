...
<input type="hidden" name="module_subject" id="module_subject" value="<?php echo $subjectId?>" />
<div><label><span>所属学科：</span>不可修改<br />
        <input type="text"  name="subject_caption" class="easyui-validatebox" required="true" value="<?php echo $subjectCaption?>" />
    </label></div>
<div><label><span>模块标题：</span>知识模块中文名称<br />
        <input type="text"  name="module_caption" class="easyui-validatebox" required="true" value="" />
    </label></div>
<div><label><span>模块编码：</span>知识模块编码<br />
        <input type="text"  name="module_code" class="easyui-validatebox" style="ime-mode:disabled" required="true" value="" />
    </label></div>
