...
window.FlexPaperViewerEmbedding = window.$f = function(id, args) {
    ...
    _jsDirectory 		= (config.jsDirectory!=null?config.jsDirectory:"/static/js/flexpaper/");
    _cssDirectory 		= (config.cssDirectory!=null?config.cssDirectory:"/static/css/");
    ...
    window[instance] = flashembed(id, {
        ...
        version					    : [10, 0],
        expressInstall			    : "/static/js/flexpaper/expressinstall.swf",
        wmode					    : _WMode
    },{
        ElementId               : id,
        SwfFile  				: _SWFFile,
