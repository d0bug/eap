...
function add_level(divId){
	...
	html += '名称：<input type="text" id="levelname_'+new_num+'" name="name[]" value="" size="8">&nbsp;&nbsp;';
	html += '上限：<input type="text" id="levelup_'+new_num+'" name="up[]" value="" size="2">&nbsp;&nbsp;';
	html += '下限：<input type="text" id="levellow_'+new_num+'" name="low[]" value="" size="2">&nbsp;&nbsp;';
	html += '说明：<input type="text" id="leveldesc_'+new_num+'" name="desc[]" value="" size="15">&nbsp;&nbsp;';
