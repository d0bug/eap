var Keditor = parent.KindEditor;
var extraPath = Keditor.basePath + '/plugins/jmeditor/extra/'
 document.write(
 "<link href=\"" + extraPath + "mathquill-0.9.1/mathquill.css\" rel=\"stylesheet\" type=\"text/css\" />" +
"<script type=\"text/javascript\" src=\"" + extraPath + "mathquill-0.9.1/mathquill.min.js\"></script>" +
...
function jmeInit(){
		...
		//公式编辑框
		$("#jme-math").html("").css("font-size",12).mathquill('editable').mathquill('write', "");
}